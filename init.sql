--- user表
INSERT INTO python_fastapi_admin.`user`
(id, username, password, email, phone, is_active, created_at, updated_at, deleted_at, token_version)
VALUES(1, 'admin', '$2b$12$LBADLUWYfpP.Z6G3ITRALeoBHo1K0NbGnHmCs1a0PmA0du4hCsFGq', 'admin@qq.com', '1111', 1, '2026-03-29 21:22:23', '2026-04-09 13:58:53', NULL, 33);
INSERT INTO python_fastapi_admin.`user`
(id, username, password, email, phone, is_active, created_at, updated_at, deleted_at, token_version)
...
--- role表
INSERT INTO python_fastapi_admin.`role`
...
--- user_role表
INSERT INTO python_fastapi_admin.user_role
(user_id, role_id)
VALUES(1, 1);
INSERT INTO python_fastapi_admin.user_role
(user_id, role_id)
...
--- permission表
INSERT INTO python_fastapi_admin.permission
...
--- role_permission表
INSERT INTO python_fastapi_admin.role_permission
...
--- menu表
INSERT INTO python_fastapi_admin.menu
